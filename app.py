...
def user_input_features():
    ...
    state = st.sidebar.selectbox('Account billing address state', options=['PA', 'NY', 'MA', 'NJ', 'CT', 'ME', 'RI', 'VT', 'NH'])
    ...
    overpaymentInd90d = st.sidebar.selectbox('Indicator that account was overpaid in last 90 days', options = ['0','1'])
    ...
    indOwnsHome = st.sidebar.selectbox('Indicator that the customer owns a home', options = ['0','1'])
